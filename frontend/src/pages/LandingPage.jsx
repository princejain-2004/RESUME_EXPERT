    ...
    <div className={landingPageStyles.container}>
      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          {/* Logo */}
          <div
            className={landingPageStyles.logoContainer}
            onClick={() => navigate("/")}
          >
          ...
          <div className="hidden md:flex items-center gap-4">
            {user ? (
              <ProfileInfoCard onClick={() => navigate("/dashboard")} />
            ) : (
              <button
          ...
          <div className={landingPageStyles.heroGrid}>
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>
                Create a professional job-winning resumes in minutes with expertly designed templates.
  ...
  <div className={landingPageStyles.featuresContainer}>
    <div className={landingPageStyles.featuresHeader}>
      ...
      <p className={landingPageStyles.featuresDescription}>
        Everything you need to create a professional standout resume that gets
        you hired.
      </p>
    </div>
    ...
    <div className={landingPageStyles.featuresGrid}>
              ...
              <div className={landingPageStyles.ctaCard}>
                  ...
                  <div className={landingPageStyles.ctaCardContent}>
                      ...
                      <p className={landingPageStyles.ctaDescription}>
                        Join thousands of successful professionals who have landed their dream jobs with ResumeExpert. Start crafting your perfect resume today!
                      </p>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          ...
          <a href="" className={landingPageStyles.footerLink} target="_black">Resume Services</a>
        </div>
      </footer>

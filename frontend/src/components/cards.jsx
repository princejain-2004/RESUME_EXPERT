...
export const ProfileInfoCard = () => {
  ...
  return (
    <div className="flex items-center gap-3 max-w-full min-w-0 bg-white px-3 py-1.5 rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      
      {/* Avatar */}
      <div className="w-9 h-9 flex-shrink-0 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 flex items-center justify-center text-white font-extrabold text-sm">
...
export const TemplateCard = ({thumbnailImg, isSelected, onSelect}) => {
  return(
    <div className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer transition-all duration-500 hover:sacle-105 hover:shadow-lg rounded-3xl
    ${
      ...
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
           ...
           <div className="absolute inset-0 bg-gradient-to-t from-white/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-100"/>
        ...
        <div className="w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-50 via-violet-600 to-fuchsia-50 ">
          <div className="w-12 h-12 bg-gradient-to-bt from-violet-500 to-fuchsia-500 rounded-2xl flex items-center justify-center mb-3">
